  ...
  return (
    <section className="px-6">
      ...
      <div className="flex gap-2 justify-center mb-6 flex-wrap">
        ...
        <a className="flex items-center gap-2 text-sm px-3 py-2 border border-gray-300 rounded-full hover:border-gray-400 transition-all font-normal" href="https://map.kakao.com/link/map/871883439" target="_blank" rel="noreferrer">
